...
class JsButtonElement(JsDomElement):
    def click(self) -> None: ...

class JsVideoElement(JsDomElement):
    autoplay: bool
    controls: bool
    src: str
    ...
    videoHeight: int
    videoWidth: int
    def play(self) -> PyodideFuture[None]: ...
...
class JsCanvasElement(JsDomElement):
    ...
    def getContext(self, contextId: str) -> JsProxy: ...
    def toBlob(self, callback: Callable[[Blob], None], mimeType: str) -> None: ...

class JsAnchorElement(JsDomElement):
    href: str
    target: str
    download: str
    def click(self) -> None: ...
...
class CanvasRenderingContext2D(JsProxy):
    ...
    @overload
    def drawImage(self, image: JsImgElement | JsVideoElement, dx: int, dy: int) -> None: ...
    @overload
    def drawImage(self, image: JsImgElement | JsVideoElement, dx: int, dy: int, dWidth: int, dHeight: int) -> None: ...
    def drawImage(
        self, image: JsImgElement | JsVideoElement, dx: int, dy: int, dWidth: int = ..., dHeight: int = ...
    ) -> None: ...
...
class document(_JsObject):
    ...
    @overload
    @staticmethod
    def createElement(tagName: Literal["a"]) -> JsAnchorElement: ...
    @overload
    @staticmethod
...
class MediaDevices(_JsObject):
    def enumerateDevices(self) -> PyodideFuture[JsArray[MediaDeviceInfo]]: ...
    def getUserMedia(self, constraints: dict[str, Any]) -> PyodideFuture[MediaStream]: ...

class MediaDeviceInfo(_JsObject):
    @property
...
class MediaStream(JsProxy):
    ...
    def getAudioTracks(self) -> JsArray[MediaStreamTrack]: ...
    def getTrackById(self, id: str) -> MediaStreamTrack | None: ...
    def getTracks(self) -> JsArray[MediaStreamTrack]: ...
    def getVideoTracks(self) -> JsArray[MediaStreamTrack]: ...
    def removeTrack(self, track: MediaStreamTrack) -> None: ...

class MediaStreamTrack(_JsObject):
    @property
    def id(self) -> str: ...
    @property
    def kind(self) -> str: ...
...
class ImageCapture(JsProxy):
    def takePhoto(self) -> PyodideFuture[Blob]: ...
