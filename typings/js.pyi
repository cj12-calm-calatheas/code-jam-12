...
class CanvasRenderingContext2D(JsProxy):
    ...
    @overload
    def drawImage(self, image: JsImgElement, dx: int, dy: int, dWidth: int, dHeight: int) -> None: ...
    def drawImage(self, image: JsImgElement, dx: int, dy: int, dWidth: int = ..., dHeight: int = ...) -> None: ...
...
class DOMParser(JsProxy):
    def parseFromString(self, string: str, type: str) -> document: ...
